...
trials.visual_off_time = NaT(height(trials),1); % also preallocate visual off times similarly
trials.fix_time = NaT(height(trials),1);        % if you store fix_time as datetime too

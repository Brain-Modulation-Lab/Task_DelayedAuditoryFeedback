...
for k = 1:10
    writer(zeros(op.audio_frame_size,1));
    vfd(zeros(op.audio_frame_size,1), 0);
end
...
playChunked = @(x) localPlayChunked_writer(x, audio_writer, cfg.audio_frame_size);

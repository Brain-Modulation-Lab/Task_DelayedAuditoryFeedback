...
refTime = NaN;
if ~cfg.no_audio_debug_mode
    % (keep your exact writer-based beep code here)
    % set refTime on first beep, then play 3 beeps
else
    % silent/visual beeps (no audio path changes)
    fs_beep = 0.20; gap = 0.30;
    for i = 1:3
...
% Log instruction onset (monotonic seconds) and flip + photodiode

...
cfg.audio_sample_rate     = 48000;      % Audio sample rate in Hz
cfg.audio_frame_size      = 256;        % block size Task_* uses for streaming; Sam's default = 128
cfg.audio_playback_gain   = 0.3;          % DAF output gain
cfg.fix_cross_dur         = 1;        % pre-sentence fix (Task_* uses its own ITI_S but we keep parity)
cfg.delay_dur             = 0.3;        % pre-visual onset delay 

...
try:
    ...
    with sf.SoundFile( r"C:\Users\abush\Desktop\audio_testing.wav", mode='w', samplerate=44100, channels=3, subtype='PCM_24') as file:
        ...
        with sd.InputStream(device=args.device, channels=3, callback=callback,
